...
print($field.'<br>'); ?>
as your field of interest.There are many volunteers inetersted 
...
<div id="flip" >Volunteer List<br>click to view!!!</div>
<div id="panel">
...
while($row = mysql_fetch_array($query)) //display all rows from query
  {
    ...
    if($table_users=='YES') // checks if there are any matching fields
    {
        ...
        background-color:lightgrey; border: 4px solid; 
        font-size: 14pt;">');
 ...
 <h2 
        ...
        You can change this field and view a different list of volunteers by going back to the organisation
