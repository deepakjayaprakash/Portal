...
.hero{
  ...
  width: 100%;
  height: 560px;
  background: url('img/volunteering.png') no-repeat;
            ...
            <div class="heading pull-left infinite animated wow wobble">
             ...
             <nav class="pull-left">
                <ul class="list-unstyled">
                    ...
                    <li class="animated wow bounceInLeft" data-wow-delay="0s"><a href="#personal"> Personal</a></li>
...
<!--  Hero Section  -->
    ...
    <!-- personal section-->
        ...
        color:LightSalmon;">Personal Details</h2>
  ...
  $user = $_SESSION['user']; //assigns user value
        ...
        $result=mysql_query("SELECT * FROM vol ");
...
<div id="panel">
    ...
    <form role="form" action="home_vol.php" method="post">
    <ol>
  ...
  name="contact" required="required"/></div></li> <br/>
   ...
   <div class="form-group">
       ...
       <br>
   <li>    Time expected by the volunteer:</li><br>
   <div class="form-group"> 
...
<div id="flip2">Find Organisations</div>
<div id="panel2">

<form action="dashboard_vol.php" method="post">
Skills/Interests:<br>
...
//updating the database for edit option
    mysql_query("UPDATE vol SET  password='$password'
    ...
    Print '<script>window.location.assign("home_vol.php");</script>'; // redirects to register.php
  }
