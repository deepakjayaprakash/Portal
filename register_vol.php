...
h2:hover{transition:0.3s;font-size: 29pt;}
  ...
  <body>
    ...
    <h2 class="animated wow rubberBand" data-wow-delay=".8s" 
        ...
        color:lightgrey;">Volunteer Registration Page</h2>
    ...
    <section class="hero" id="hero" >
        <div class="container">
            ...
            <h1 class="animated wow zoomIn" data-wow-delay=".8s" >
                It's not how much we give, but how much love<br>
                 we put into giving<br>-Mother Teresa</h1>
<div class="animated wow fadeInDown" data-wow-delay="1.2s" 
style="font-size:15pt; font-style:italic;font-weight:bold;" ><p>You're a few steps from becoming a part of the volunteer 
community!!!!</p>
<br><br>
<p>Please fill all the credentials required to improve our 
organisation suggestions.</p>
</div>
</div>
</div>
...
<div id="panel">
    ...
    <form role="form" action="register_vol.php" method="post">
  <li>    <div class="form-group"> Name : 
  ...
  name="contact" required="required"/></div></li> <br/>
   ...
   <li>  Description:</li><br>
        ...
        class="form-control" rows="6" cols="60" >Describe yourself
         briefly in few lines.</textarea> </div><br/>
...
$period="an";
  ...
  $query = mysql_query("Select * from vol"); //Query the users table
  while($row = mysql_fetch_array($query)) //display all rows from query
  {
    ...
    if($username == $table_users) // checks if there are any matching fields
    {
      ...
      Print '<script>window.location.assign("register_vol.php");</script>'; // redirects to register.php
    }
  }
  if($bool) // checks if bool is true
  { 
    mysql_query("INSERT INTO vol (username, password, location,contact, 
