...
.hero{
  ...
  width: 100%;
  height: 560px;
  background: url('img/vol.jpg') no-repeat fixed center center;
  opacity: 0.9;
...
h2:hover{transition:0.3s;font-size: 29pt;}
    ...
    <header>
          <div class="container">
            <div class="heading pull-left animated wow wobble">
                <h1>Portal</h1>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="register_vol.php">Register</a></li>
        ...
        style="text-align:center; color:lightgrey;">Volunteer Login Page</h2>
    <!--  Hero Section  -->
    <section class="hero" id="hero" >
        <div class="container">
            <div class="caption">
               <h1 class="animated wow zoomIn" data-wow-delay=".8s">
             One person can make a difference, and <br>everyone should try. <br>– John F Kennedy</h1>
                 <div align="center">
<br><br>
                <h2 class=" animated wow swing" data-wow-delay=".8s">
                Haven't Registered yet?</h2>
                <a href="register_vol.php"> click here to register</a>
...
<br>
 <div style="text-align:center; 
         border: 4px solid; font-style:bold;color:coral;
        font-size: 14pt; letter-spacing: 3px;padding: 2px;line-height: 30px;">

        <form action="checklogin_vol.php" method="POST">
            <h2>LOGIN</h2>
